...
namespace Idle_Game
{
    public class Engine
    {
        ...
        public static int totalXP = 250;

        public static double money;

        public static double health = 200;
        public static int defence = 0;
        public static double defenceReduction = 0;
        public static int totalHealth = 200;
        ...
        public static bool isNewGameOn2 = false;
        public static bool isNewGameOn3 = false;
        public static bool isNewGameClicksOn = false;
        public static bool isNewGameClicksOn2 = false;
        public static bool isNewGameClicksOn3 = false;
        public static bool isNewGameDefenceOn = false;
