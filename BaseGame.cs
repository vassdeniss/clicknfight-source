...
namespace ClickNFight
{
    public partial class Form1 : Form, IUiRefreshers
    {
        ...
        private void FightButton_Click(object sender, EventArgs e)
        {
            ...
            //int xpMultiplier = 1 + Engine.woodenSwordAdd + Engine.stoneSwordAdd + Engine.ironSwordAdd + Engine.diamondSwordAdd +
            ...
            //int receivedXpWithMultiplier = xpMultiplier * receivedXp;
            #endregion

            Random xpRandomizer = new Random();
            int receivedXp = xpRandomizer.Next(1, 6);

            this.hero.CurrentXp += receivedXp;
            this.hero.MonstersSlain++;
